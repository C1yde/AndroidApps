...
import com.example.rxtasks.Tasks.RxTask1;
...
public class RxTask1Test {
    @Test
    public void testInput1() throws Exception {
        List<String> list = createList("Hello", "Reactive", "World");

        Observable<Integer> observable = RxTask1.task(list);
    ...
    public void testInput3() throws Exception {
        ...
        Observable<Integer> observable = RxTask1.task(list);
        testObservable(Observable.<Integer>empty(), observable);
    }
